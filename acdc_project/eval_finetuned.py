...
def parse_args():
    ...
    parser.add_argument('--weight_url', type=str, 
                        default='/home/deng/efficientvit/checkpoints/acdc_full_v2/best_model.pth')
    ...
    parser.add_argument('--finetuned', action='store_true', 
                        help='Set this flag if loading a finetuned model')
...
def load_model(model_name, weight_path, num_classes=19, finetuned=False):
    ...
    if finetuned:
        # For finetuned model, load checkpoint
        ...
        if 'miou' in checkpoint:
            print(f"Checkpoint mIoU: {checkpoint['miou']:.2f}%")
        ...
        print(f"Loaded state_dict with {len(new_state_dict)} keys")
        ...
        # For pretrained model, load official checkpoint
